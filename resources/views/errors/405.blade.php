...
<head>
    ...
    <title>405 - Metode Tidak Diizinkan | {{ config('app.name') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        <div class="w-full max-w-lg text-center">
            ...
            <div class="card-cute p-8">
                <!-- Error Code -->
                <h1 class="text-8xl font-bold bg-gradient-primary bg-clip-text text-transparent font-heading mb-4">405
                </h1>

                <!-- Message -->
                <h2 class="text-2xl font-bold text-neutral-800 font-heading mb-4">
                    Metode Tidak Diizinkan ⚠️
                </h2>
                <p class="text-neutral-500 mb-8 font-medium">
                    Metode permintaan yang Anda gunakan tidak diizinkan untuk halaman ini. Silakan gunakan metode yang
                    sesuai atau kembali ke halaman sebelumnya.
                </p>
