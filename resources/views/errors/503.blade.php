...
<head>
    ...
    <title>503 - Dalam Pemeliharaan | {{ config('app.name') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        <div class="w-full max-w-lg text-center">
            ...
            <div class="card-cute p-8">
                <!-- Error Code -->
                <h1 class="text-8xl font-bold bg-gradient-primary bg-clip-text text-transparent font-heading mb-4">503
                </h1>
                ...
                <p class="text-neutral-500 mb-6 font-medium">
                    Sistem sedang dalam pemeliharaan untuk meningkatkan layanan kami. Silakan kembali dalam beberapa
                    saat. Terima kasih atas kesabaran Anda.
                </p>

                <!-- Status -->
                <div
                    class="bg-gradient-to-r from-primary-50 to-accent-50/50 rounded-2xl p-4 mb-8 border-2 border-primary-100">
                    <div class="flex items-center justify-center gap-3 text-primary-600">
                        <svg class="w-5 h-5 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                        </svg>
                        <span class="font-bold">Sedang dalam proses... ✨</span>
                    </div>
                </div>
