...
<head>
    ...
    <title>401 - Tidak Terautentikasi | {{ config('app.name') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        <div class="w-full max-w-lg text-center">
            ...
            <div class="card-cute p-8">
                <!-- Error Code -->
                <h1 class="text-8xl font-bold bg-gradient-primary bg-clip-text text-transparent font-heading mb-4">401
                </h1>
                ...
                <p class="text-neutral-500 mb-8 font-medium">
                    Anda perlu login terlebih dahulu untuk mengakses halaman ini. Silakan masuk dengan akun Anda.
                </p>
