    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        <div class="w-full max-w-lg text-center">
            ...
            <div class="card-cute p-8">
                <!-- Error Code -->
                <h1 class="text-8xl font-bold bg-gradient-primary bg-clip-text text-transparent font-heading mb-4">429
                </h1>
                ...
                <p class="text-neutral-500 mb-8 font-medium">
                    Anda telah mengirim terlalu banyak permintaan dalam waktu singkat. Silakan tunggu beberapa saat
                    sebelum mencoba lagi.
                </p>

                <!-- Actions -->
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button onclick="setTimeout(() => location.reload(), 3000)" class="btn-primary">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>Coba Lagi dalam 3 Detik</span>
                    </button>
