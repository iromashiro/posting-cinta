...
<div class="page-header">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="page-title">Daftar Ibu</h1>
            <p class="page-subtitle">Kelola data ibu yang terdaftar di posyandu</p>
        </div>
...
<div class="card card-padding text-center">
    <div class="py-8">
        ...
        <h3 class="text-lg font-semibold text-neutral-800 mb-2">Belum Ada Data Ibu</h3>
...
<div class="card card-padding mb-4">
    <div class="flex items-center gap-3">
        ...
        <div>
            <p class="text-sm text-neutral-500">Total Ibu Terdaftar</p>
            <p class="text-xl font-bold text-neutral-900">{{ $items->total() }} Ibu</p>
        </div>
    </div>
</div>
    ...
    <table class="table-premium">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="text-neutral-700">{{ $item->nik ?: '-' }}</span>
                </td>
                <td>
                ...
                <td>
                    @if($item->phone)
                    <a href="tel:{{ $item->phone }}" class="text-primary-600 hover:underline">
                        {{ $item->phone }}
                    </a>
                    @else
                ...
                <td>
                    ...
                    <span class="badge badge-success">{{ $item->children_count }} anak</span>
                    @else
                ...
                <td>
                    <div class="flex items-center gap-2">
                        <a href="{{ route('mothers.show', $item) }}" class="btn-ghost btn-sm" title="Lihat Detail">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('mothers.edit', $item) }}" class="btn-secondary btn-sm" title="Edit Data">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="mt-6 card card-padding bg-blue-50 border-blue-200">
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
            <h4 class="font-semibold text-blue-900 mb-1">Tips Manajemen Data Ibu</h4>
