                        ...
                        <div class="entry col-md-4 col-sm-6 col-12">
                            <div class="grid-inner">
                                <div class="entry-image">
                                    <img src="{{ URL::asset($b->thumbnail) }}" width="500" height="281" alt="">
                                </div>
                                <div class="entry-title">
                                    <h2><a href="{{ route('berita.guest', $b->slug) }}">{{ $b->judul }}</a></h2>
                                </div>
                                ...
                                <div class="entry-content">
                                    ...
                                    <a href="{{ route('berita.guest', $b->slug) }}" class="more-link">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
