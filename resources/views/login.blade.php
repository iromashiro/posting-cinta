...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('adm_dinsos//vendor/@fortawesome/fontawesome-free/css/all.min.css') }}"
        type="text/css">
    <!-- Argon CSS -->
    <link rel="stylesheet" href="{{ URL::asset('adm_dinsos//css/argon.css?v=1.1.0') }}" type="text/css">
</head>
...
<body class="bg-default">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            <h1 class="text-white">Website Puskesmas</h1>
                            <h2 class="text-white">Nama Puskesmas</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <small>Silakan masukkan username & password Anda</small>
                            </div>
                            <form role="form" action="{{ route('admin.login') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input id="email" type="text"
                                            ...
                                            name="email" value="{{ old('email') }}" placeholder="admin@gmail.com"
                                            required autofocus>
                                    </div>
                                    @if ($errors->has('email'))
                                ...
                                @if (session('pesan'))
                                <div class="mt-2 bg-info text-white p-2 rounded shadow">
                                    {{ session('pesan') }}
                                </div>
                                @endif
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="copyright text-center">
                        &copy; Unit Layanan Pengadaan made with &hearts; <a href="http://portfolioku.com"
                            class="font-weight-bold ml-1" target="_blank">
                            Diskominfo Kabupaten Muara Enim</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Argon JS -->
    <script src="{{ URL::asset('adm_dinsos//js/argon.js?v=1.1.0') }}"></script>
