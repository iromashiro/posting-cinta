                        ...
                        <div class="entry clearfix">
                            ...
                            <div class="entry-meta">
                                <ul>
                                    ...
                                    <li><a href="https://www.facebook.com/sharer/sharer.php?u=https://dpppa.muaraenimkab.go.id/berita/{{ $berita->slug }}"
                                            target="_blank">
                                            Share ke Facebook
                                            <i class="icon-camera-retro"></i></a></li>

                                </ul>
                            </div><!-- .entry-meta end -->

                            <div class="entry-image">
                                <img src="{{URL::asset($berita->thumbnail)}}" alt="Blog Single">
                            </div><!-- .entry-image end -->
