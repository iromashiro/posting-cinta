...
<div class="page-header">
    <h1 class="page-title">Tambah {{ $isAdmin ? 'User' : 'Kader' }} Baru</h1>
    <p class="page-subtitle">Buat akun baru untuk pengguna sistem</p>
</div>
    ...
    <form method="post" action="{{ route('users.store') }}" class="space-y-6">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1 text-sm text-blue-800">
                    <strong>Tips:</strong> Data bertanda <span class="text-red-600 font-bold">*</span> wajib diisi.
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="input-helper">Minimal 8 karakter, kombinasi huruf dan angka</p>
            ...
            <div>
                ...
                <p class="input-helper">Masukkan ulang password yang sama</p>
            </div>
