...
{title: 'fluid', value: 'img-raised rounded img-fluid'}
    ...
    xhr.open('POST', '/pengumuman-tinymce');
    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Input Menu Pengumuman</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
                <form method="POST" action="{{ route('pengumuman.create') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <input class="form-control" placeholder="Judul pengumuman" name="judul" type="text" required>
                            </div>
                        </div>
                    </div>
                    <!-- Input groups with icon -->
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <textarea id="description" name="isi_pengumuman" class="form-control"
                                    name="isi_menu"></textarea>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Input Pengumuman</button>
                </form>
            </div>
        </div>
    </div>
