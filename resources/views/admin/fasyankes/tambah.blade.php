...
{title: 'fluid', value: 'img-raised rounded img-fluid'}
    ...
    xhr.open('POST', '/fasyankes-tinymce');
    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Input Menu Fasyankes</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
                <form method="POST" action="{{ route('fasyankes.create') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Input groups with icon -->
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <input class="form-control" placeholder="Nama Menu" name="nama_menu" type="text" required>
                            </div>
                        </div>
                    </div>
                    <!-- Input groups with icon -->
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <textarea id="description" name="isi_menu" class="form-control"
                                    name="isi_menu"></textarea>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Input Fasyankes</button>
                </form>
            </div>
        </div>
    </div>
