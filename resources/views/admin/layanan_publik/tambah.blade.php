...
{title: 'fluid', value: 'img-raised rounded img-fluid'}
    ...
    xhr.open('POST', '/layanan_publik-tinymce');
    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Input Menu Profil</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
                <form method="POST" action="{{ route('layanan_publik.create') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Input Profil</button>
                </form>
            </div>
        </div>
    </div>
