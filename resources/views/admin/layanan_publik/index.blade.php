    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">List Layanan Publik</h3>

                <div class="pt-3">
                    <a href="{{ route('layanan_publik.tambah') }}" class="btn btn-success">Tambah Data</a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('layanan_publik.destroy', $ga->id) }}" method="post">
                                        @method('delete')
                                        @csrf
