    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Input Menu Artikel</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
                <form method="POST" action="{{ route('artikel.create') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <input class="form-control" placeholder="Judul artikel" name="judul" type="text"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <textarea id="description" name="isi_artikel" class="form-control"
                                    name="isi_menu"></textarea>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Input artikel</button>
                </form>
            </div>
        </div>
    </div>
